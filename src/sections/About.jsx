  ...
  return (
    <Section id="about" ref={containerRef} className="overflow-x-clip px-6">
      <div className="relative w-full min-h-screen overflow-hidden flex flex-col gap-15 py-20">
        <h2 className="about font-neuton font-bold text-6xl md:text-7xl lg:text-9xl border-b border-b-gray-400"></h2>
        <p className="para lg:self-end absolute top-1/3 font-neuton text-2xl md:text-5xl lg:text-7xl lg:w-2/3">
